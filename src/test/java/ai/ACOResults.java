...
public class ACOResults {
    ...
    private static final String[] pheromoneTrailImplementations = new String[]{"MATRIX"};
    private static final String[] TSPInstanceImplementations = new String[]{"ADJ_MATRIX"};
    ...
    public void testResultOnDuplicatesCycledTourAndNumberOfNodes(String pheromoneImplementation, String tspInstanceImplementation) throws IOException {
        ...
        Assertions.assertEquals(53, tour.length,"Tour has invalid length");
